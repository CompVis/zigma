        ...
        **kwargs: Any,
        ...
        if isinstance(feature, int):
            ...
            self.inception = NoTrainInceptionV3(
                name="inception-v3-compat", features_list=["768"]
            )
...
if __name__ == "__main__":
    ...
    _ = torch.manual_seed(123)
    prdc = sFrechetInceptionDistance().to("cuda")

    imgs_dist1 = torch.randint(0, 200, (100, 3, 299, 299), dtype=torch.uint8).to("cuda")
    imgs_dist2 = torch.randint(100, 255, (100, 3, 299, 299), dtype=torch.uint8).to(
        "cuda"
    )
